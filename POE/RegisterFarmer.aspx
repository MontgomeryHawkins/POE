<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/EmpLoggedIn.Master" CodeBehind="RegisterFarmer.aspx.cs" Inherits="POE.RegisterFarmer" %>
...
<div class="container">
    ...
    Height="430px" Width="250px" BackColor="White">
        <p class="pstyle">Add a farmer to the system</p>
        <div>
            <label class="labelstyle">Farmer Username:</label>
